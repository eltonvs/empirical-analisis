...
template <typename T>
int mixed_search_nth(T, T, int, int, int, int (*)(std::vector<T>, T, int, int));

template <typename T>
int sorted_search_nth(T, T, int, int, int, int (*)(std::vector<T>, T, int, int));
...
template <typename T>
long double time_measurement_nth(int, int (*)(T, T, int, int, int, int (*)(T, T, int, int)), T, std::vector<long int>::const_iterator, int, int, int, int (*)(T, T, int, int));
